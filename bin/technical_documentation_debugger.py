...
parser.add_argument('--inputfunc', '-if', 
                    metavar="functional_requirements.txt",
                    type=argparse.FileType('r'),
                    required=True, 
                    help="Text file with functional requirement cards")
parser.add_argument('--inputvisual', '-iv', 
                    metavar="visual_requirements.txt",
                    type=argparse.FileType('r'), 
                    help="Text file with visual requirements")
parser.add_argument('--output', '-o', 
                    metavar="output_file.dot", 
                    type=argparse.FileType('w'), 
                    help="Output file for the graphviz .dot layout")
...
if args.inputvisual is not None:
...
if args.inputvisual is not None:
            ...
            for requirement in card_fulfills:
                if requirement not in fulfilled_functional_requirements:
                    if requirement in functional_requirements:
                        ...
                        print("Visual requirement " + card_id + 
                              " refers to functional requirement " + 
    ...
    print("The following functional requirements are not fulfilled by a visual requirement: " +
          str(functional_requirements))

    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.CharField(choices=[('AP', 'Created by app'), ('US', 'Created by user')],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', auto_created=True, primary_key=True, serialize=False)),
                ('path', models.CharField(choices=[('simple', 'menu/menus/simple.html'),
                                                   ('standard', 'menu/menus/simple.html')],
                                          default='standard', max_length=10, unique=True)),

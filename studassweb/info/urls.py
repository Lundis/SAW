...
urlpatterns = patterns('',
    ...
    url(r'^cat/(?P<category_id>\d+)/delete$', 'info.views.delete_category', name='info_delete_category'),
    ...
    url(r'^page/(?P<page_id>\d+)/delete', 'info.views.delete_page', name='info_delete_page')
)

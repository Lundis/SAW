...
urlpatterns = patterns('',
    ...
    url(r'^cat/new$', 'info.views.edit_category', name='info_new_categories'),
    ...
    url(r'^cat/(?P<category_id>\d+)/delete$', 'info.views.edit_page', name='info_create_category'),
    url(r'^page/(?P<page_id>\d+)$', 'info.views.view_page', name='info_view_page'),
    url(r'^page/new$', 'info.views.edit_page', name='info_new_page'),
